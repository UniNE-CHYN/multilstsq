...
class MultiLstSq:
    ...
    def __init__(self, problem_dimensions, n_parameters, internal_dtype=numpy.float):
        ...
        :param problem_dimensions: Tuple, size of the problem array, it can be ``()`` (0-dimensional), for a single least square problem, or for example
            ``(800, 600)`` for 800x600 times the regression problem
        ...
        if self._cache_beta is None:
            ...
            with warnings.catch_warnings():
                ...
                if self._Xty.shape[-2] == 1:
                    ...
                    self._cache_beta[..., 0, 0] = self._Xty[..., 0, 0] * (self._XtX[..., 0, 1] * self._XtX[..., 1, 0] / (self._XtX[..., 0, 0] * (self._XtX[..., 1, 1] - self._XtX[..., 0, 1] * self._XtX[..., 1, 0] / self._XtX[..., 0, 0])) + 1) / self._XtX[..., 0, 0] - self._XtX[..., 0, 1] * self._Xty[..., 1, 0] / (self._XtX[..., 0, 0] * (self._XtX[..., 1, 1] - self._XtX[..., 0, 1] * self._XtX[..., 1, 0] / self._XtX[..., 0, 0]))  # pep8: disable=E501
