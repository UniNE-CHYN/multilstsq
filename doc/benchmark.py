...
if __name__ == '__main__':
    ...
    from multiregression import ModelMultiregression
    import numpy
    import time
    ...
    times_multiregression = []
    for s in range(minsh, maxsh):
        mmr = ModelMultiregression((s, ), d['model'])
        t = time.time()
        ...
        beta = mmr.beta
        dt = time.time() - t
        times_multiregression.append(dt)
        #print(n, s)
        #print(times_multiregression)
    ...
    plt.plot(times_multiregression)
